...
features = [
    ...
    'estkat', 'progkat2', 'cerb2', 'ki67pre','luminalsubtip', 'klinikEVREKAT',
...
categorical_features = ['KLİNİKLAP', 'USGLAP', 'MRLAP','luminalsubtip', 'klinikEVREKAT']
...
for train_index, val_index in kfold.split(X_final):
    ...
    # model structure
    model = Sequential()
    model.add(Dense(128, input_dim=X_train.shape[1], activation='tanh', kernel_regularizer=l2(0.001)))
...
model.save('models/metastasis_model.h5')
