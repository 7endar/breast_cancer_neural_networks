...
for train_index, val_index in kfold.split(X_final):
    ...
    # model structure
    model = Sequential()
    model.add(Dense(160, input_dim=X_train.shape[1], activation='relu', kernel_regularizer=l2(0.001)))
...
model.save('models/tumor_type_model.h5')
